    ...
    public class InsuranceCompany : Organization
    {
        ...
        public override bool IsContains(string text)
        {
            ...
            if (NumberOfEmployees.ToString().Contains(text)
                ...
                || NumberOfInsuredPersons.ToString().Contains(text)) return true;
            else return false;
        }
    }
}
